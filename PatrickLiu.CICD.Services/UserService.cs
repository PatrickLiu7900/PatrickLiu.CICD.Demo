using PatrickLiu.CICD.Interfaces;
using PatrickLiu.CICD.Models;
using System;
using System.Collections.Generic;
using System.Linq;

namespace PatrickLiu.CICD.Services
{
    /// <summary>
    /// 实现用户服务接口的实现类型。
    /// </summary>
    public class UserService : IUserService
    {
        ...
        public UserService()
        {
            ...
            { new User {ID=1,Name="黄飞鸿-修改",Account="HuangFeiHong",Password="HuangFeiHong123456",Email="huangFeiHong@sina.com", Role="Admin", LoginTime=DateTime.Now },
